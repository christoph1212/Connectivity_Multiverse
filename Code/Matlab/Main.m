...
dir_Preproc         = fullfile(dir_Root, 'Data', 'NewPreprocessed');    % path where preprocessed data should be stored (will be created)
dir_Connect         = fullfile(dir_Root, 'Data', 'NewConnectivity');    % path where connectivity data should be stored (will be created)
