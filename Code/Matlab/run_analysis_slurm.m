...
dir_Log             = fullfile(dir_Root, 'Data', 'New_Log');            % path where log data should be stored
dir_Preproc         = fullfile(dir_Root, 'Data', 'New_Preprocessed');    % path where preprocessed data should be stored (will be created)
dir_Connect         = fullfile(dir_Root, 'Data', 'New_Connectivity');    % path where connectivity data should be stored (will be created)
